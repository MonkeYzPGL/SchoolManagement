...
public class seeGrades {
	...
	private JFrame frame = new JFrame("Note Student");
	...
	public seeGrades(String profil, String nume, String CNP) {
		connection();
	...
	public void grades(String profil, String nume, String CNP) {
		...
		try {
			...
			ResultSet rs = s.executeQuery("call proiect.showNotes('" + CNP + "')");
